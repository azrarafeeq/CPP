...
/*   Updated: 2023/05/14 15:32:24 by arafeeq          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (name != "")
	{
		...
		std::cout << "ClapTrap " << name << " was attacked, which caused a damage of " << amount << " amount !";
		std::cout << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (name != "")
	{
		...
		std::cout << "ClapTrap " << name << " got repaired with an amount of " << amount << " !";
		std::cout << std::endl;
		this->energy_points -= 1;
		this->hit_points += amount;
		if (this->energy_points <= 0 || this->hit_points <= 0)
